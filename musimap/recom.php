...
$headers = [
    ...
    'Authorization: Bearer '.base64_encode('RHizSXaEzrixKbOVhUcEhFDG6FF8lkx84TMIbvBF')  // replace it with a generated access_token
];

// Set some options
curl_setopt_array($curl, [
    CURLOPT_RETURNTRANSFER => true,
    //test search track by name
    //CURLOPT_URL => 'https://api.musimap.net/tracks/search?name=thriller',
    CURLOPT_URL => 'https://api.musimap.net/tracks/search?name=thriller',
